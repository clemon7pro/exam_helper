...
class ExcelReader(object):
    ...
    def read(self, file):
        ...
        for _, raw_question in raw_questions.iterrows():
            ...
            match raw_question[model["question_type"]]:
                case "单选题" | "多选题":
                    options = []
                ...
                case "简答题":
                    questions.append(Question(
                        ...
                        stem=raw_question[model["question_stem"]],
                        answer=str(raw_question[model["answer"]])
                    ))
                case _:
                    pass
